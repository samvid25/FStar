...
let (uu___is_Tm_uinst : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_uinst _0 -> true | uu____1550 -> false
...
let (uu___is_Tm_constant : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_constant _0 -> true | uu____1581 -> false
...
let (uu___is_Tm_type : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_type _0 -> true | uu____1594 -> false
...
let (uu___is_Tm_abs : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_abs _0 -> true | uu____1625 -> false
...
let (uu___is_Tm_arrow : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_arrow _0 -> true | uu____1706 -> false
...
let (uu___is_Tm_refine : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_refine _0 -> true | uu____1767 -> false
...
let (uu___is_Tm_app : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_app _0 -> true | uu____1814 -> false
...
let (uu___is_Tm_match : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_match _0 -> true | uu____1897 -> false
...
let (uu___is_Tm_ascribed : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_ascribed _0 -> true | uu____2002 -> false
...
let (uu___is_Tm_let : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_let _0 -> true | uu____2105 -> false
...
let (uu___is_Tm_uvar : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_uvar _0 -> true | uu____2166 -> false
...
let (uu___is_Tm_delayed : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_delayed _0 -> true | uu____2229 -> false
...
let (uu___is_Tm_meta : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_meta _0 -> true | uu____2290 -> false
...
let (uu___is_Tm_lazy : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_lazy _0 -> true | uu____2321 -> false
...
let (uu___is_Tm_quoted : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_quoted _0 -> true | uu____2340 -> false
...
let (uu___is_Tm_unknown : term' -> Prims.bool) =
  fun projectee ->
    match projectee with | Tm_unknown -> true | uu____2370 -> false
...
let (uu___is_Ctx_uvar_meta_tac : ctx_uvar_meta_t -> Prims.bool) =
  fun projectee ->
    match projectee with | Ctx_uvar_meta_tac _0 -> true | uu____2747 -> false
...
let (uu___is_Total : comp' -> Prims.bool) =
  fun projectee ->
    match projectee with | Total _0 -> true | uu____3348 -> false
...
let (uu___is_GTotal : comp' -> Prims.bool) =
  fun projectee ->
    match projectee with | GTotal _0 -> true | uu____3393 -> false
let (__proj__GTotal__item___0 :
  comp' -> (term' syntax * universe FStar_Pervasives_Native.option)) =
  fun projectee -> match projectee with | GTotal _0 -> _0
let (uu___is_Comp : comp' -> Prims.bool) =
  fun projectee ->
    match projectee with | Comp _0 -> true | uu____3430 -> false
let (__proj__Comp__item___0 : comp' -> comp_typ) =
  fun projectee -> match projectee with | Comp _0 -> _0
let (uu___is_TOTAL : cflag -> Prims.bool) =
  fun projectee -> match projectee with | TOTAL -> true | uu____3442 -> false
let (uu___is_MLEFFECT : cflag -> Prims.bool) =
  fun projectee ->
    match projectee with | MLEFFECT -> true | uu____3448 -> false
let (uu___is_LEMMA : cflag -> Prims.bool) =
  fun projectee -> match projectee with | LEMMA -> true | uu____3454 -> false
let (uu___is_RETURN : cflag -> Prims.bool) =
  fun projectee ->
    match projectee with | RETURN -> true | uu____3460 -> false
let (uu___is_PARTIAL_RETURN : cflag -> Prims.bool) =
  fun projectee ->
    match projectee with | PARTIAL_RETURN -> true | uu____3466 -> false
let (uu___is_SOMETRIVIAL : cflag -> Prims.bool) =
  fun projectee ->
    match projectee with | SOMETRIVIAL -> true | uu____3472 -> false
...
let (uu___is_SHOULD_NOT_INLINE : cflag -> Prims.bool) =
  fun projectee ->
    match projectee with | SHOULD_NOT_INLINE -> true | uu____3484 -> false
let (uu___is_CPS : cflag -> Prims.bool) =
  fun projectee -> match projectee with | CPS -> true | uu____3490 -> false
let (uu___is_DECREASES : cflag -> Prims.bool) =
  fun projectee ->
    match projectee with | DECREASES _0 -> true | uu____3499 -> false
let (__proj__DECREASES__item___0 : cflag -> term' syntax) =
  fun projectee -> match projectee with | DECREASES _0 -> _0
let (uu___is_Meta_pattern : metadata -> Prims.bool) =
  fun projectee ->
    match projectee with | Meta_pattern _0 -> true | uu____3538 -> false
...
let (uu___is_Meta_named : metadata -> Prims.bool) =
  fun projectee ->
    match projectee with | Meta_named _0 -> true | uu____3611 -> false
...
let (uu___is_Meta_labeled : metadata -> Prims.bool) =
  fun projectee ->
    match projectee with | Meta_labeled _0 -> true | uu____3630 -> false
...
let (uu___is_Meta_desugared : metadata -> Prims.bool) =
  fun projectee ->
    match projectee with | Meta_desugared _0 -> true | uu____3661 -> false
...
let (uu___is_Meta_monadic : metadata -> Prims.bool) =
  fun projectee ->
    match projectee with | Meta_monadic _0 -> true | uu____3680 -> false
...
let (uu___is_Meta_monadic_lift : metadata -> Prims.bool) =
  fun projectee ->
    match projectee with | Meta_monadic_lift _0 -> true | uu____3719 -> false
...
let (uu___is_Sequence : meta_source_info -> Prims.bool) =
  fun projectee ->
    match projectee with | Sequence -> true | uu____3755 -> false
let (uu___is_Primop : meta_source_info -> Prims.bool) =
  fun projectee ->
    match projectee with | Primop -> true | uu____3761 -> false
let (uu___is_Masked_effect : meta_source_info -> Prims.bool) =
  fun projectee ->
    match projectee with | Masked_effect -> true | uu____3767 -> false
let (uu___is_Meta_smt_pat : meta_source_info -> Prims.bool) =
  fun projectee ->
    match projectee with | Meta_smt_pat -> true | uu____3773 -> false
let (uu___is_Data_ctor : fv_qual -> Prims.bool) =
  fun projectee ->
    match projectee with | Data_ctor -> true | uu____3779 -> false
let (uu___is_Record_projector : fv_qual -> Prims.bool) =
  fun projectee ->
    match projectee with | Record_projector _0 -> true | uu____3790 -> false
...
let (uu___is_Record_ctor : fv_qual -> Prims.bool) =
  fun projectee ->
    match projectee with | Record_ctor _0 -> true | uu____3821 -> false
...
let (uu___is_DB : subst_elt -> Prims.bool) =
  fun projectee -> match projectee with | DB _0 -> true | uu____3856 -> false
...
let (uu___is_NM : subst_elt -> Prims.bool) =
  fun projectee -> match projectee with | NM _0 -> true | uu____3885 -> false
...
let (uu___is_NT : subst_elt -> Prims.bool) =
  fun projectee -> match projectee with | NT _0 -> true | uu____3916 -> false
...
let (uu___is_UN : subst_elt -> Prims.bool) =
  fun projectee -> match projectee with | UN _0 -> true | uu____3951 -> false
...
let (uu___is_UD : subst_elt -> Prims.bool) =
  fun projectee -> match projectee with | UD _0 -> true | uu____3980 -> false
...
let (uu___is_BadLazy : lazy_kind -> Prims.bool) =
  fun projectee ->
    match projectee with | BadLazy -> true | uu____4317 -> false
let (uu___is_Lazy_bv : lazy_kind -> Prims.bool) =
  fun projectee ->
    match projectee with | Lazy_bv -> true | uu____4323 -> false
let (uu___is_Lazy_binder : lazy_kind -> Prims.bool) =
  fun projectee ->
    match projectee with | Lazy_binder -> true | uu____4329 -> false
let (uu___is_Lazy_optionstate : lazy_kind -> Prims.bool) =
  fun projectee ->
    match projectee with | Lazy_optionstate -> true | uu____4335 -> false
let (uu___is_Lazy_fvar : lazy_kind -> Prims.bool) =
  fun projectee ->
    match projectee with | Lazy_fvar -> true | uu____4341 -> false
let (uu___is_Lazy_comp : lazy_kind -> Prims.bool) =
  fun projectee ->
    match projectee with | Lazy_comp -> true | uu____4347 -> false
let (uu___is_Lazy_env : lazy_kind -> Prims.bool) =
  fun projectee ->
    match projectee with | Lazy_env -> true | uu____4353 -> false
let (uu___is_Lazy_proofstate : lazy_kind -> Prims.bool) =
  fun projectee ->
    match projectee with | Lazy_proofstate -> true | uu____4359 -> false
let (uu___is_Lazy_goal : lazy_kind -> Prims.bool) =
  fun projectee ->
    match projectee with | Lazy_goal -> true | uu____4365 -> false
let (uu___is_Lazy_sigelt : lazy_kind -> Prims.bool) =
  fun projectee ->
    match projectee with | Lazy_sigelt -> true | uu____4371 -> false
let (uu___is_Lazy_uvar : lazy_kind -> Prims.bool) =
  fun projectee ->
    match projectee with | Lazy_uvar -> true | uu____4377 -> false
let (uu___is_Lazy_embedding : lazy_kind -> Prims.bool) =
  fun projectee ->
    match projectee with | Lazy_embedding _0 -> true | uu____4392 -> false
...
let (uu___is_Assumption : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Assumption -> true | uu____4815 -> false
let (uu___is_New : qualifier -> Prims.bool) =
  fun projectee -> match projectee with | New -> true | uu____4821 -> false
let (uu___is_Private : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Private -> true | uu____4827 -> false
...
let (uu___is_Visible_default : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Visible_default -> true | uu____4839 -> false
let (uu___is_Irreducible : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Irreducible -> true | uu____4845 -> false
...
let (uu___is_NoExtract : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | NoExtract -> true | uu____4857 -> false
let (uu___is_Noeq : qualifier -> Prims.bool) =
  fun projectee -> match projectee with | Noeq -> true | uu____4863 -> false
let (uu___is_Unopteq : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Unopteq -> true | uu____4869 -> false
let (uu___is_TotalEffect : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | TotalEffect -> true | uu____4875 -> false
let (uu___is_Logic : qualifier -> Prims.bool) =
  fun projectee -> match projectee with | Logic -> true | uu____4881 -> false
let (uu___is_Reifiable : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Reifiable -> true | uu____4887 -> false
let (uu___is_Reflectable : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Reflectable _0 -> true | uu____4894 -> false
...
let (uu___is_Discriminator : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Discriminator _0 -> true | uu____4907 -> false
...
let (uu___is_Projector : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Projector _0 -> true | uu____4924 -> false
let (__proj__Projector__item___0 :
  qualifier -> (FStar_Ident.lident * FStar_Ident.ident)) =
  fun projectee -> match projectee with | Projector _0 -> _0
let (uu___is_RecordType : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | RecordType _0 -> true | uu____4957 -> false
...
let (uu___is_RecordConstructor : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | RecordConstructor _0 -> true | uu____5002 -> false
...
let (uu___is_Action : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Action _0 -> true | uu____5039 -> false
...
let (uu___is_ExceptionConstructor : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | ExceptionConstructor -> true | uu____5051 -> false
let (uu___is_HasMaskedEffect : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | HasMaskedEffect -> true | uu____5057 -> false
let (uu___is_Effect : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | Effect -> true | uu____5063 -> false
let (uu___is_OnlyName : qualifier -> Prims.bool) =
  fun projectee ->
    match projectee with | OnlyName -> true | uu____5069 -> false
...
let (uu___is_Primitive_eff : eff_combinators -> Prims.bool) =
  fun projectee ->
    match projectee with | Primitive_eff _0 -> true | uu____5829 -> false
...
let (uu___is_DM4F_eff : eff_combinators -> Prims.bool) =
  fun projectee ->
    match projectee with | DM4F_eff _0 -> true | uu____5842 -> false
...
let (uu___is_Layered_eff : eff_combinators -> Prims.bool) =
  fun projectee ->
    match projectee with | Layered_eff _0 -> true | uu____5855 -> false
...
let (uu___is_Sig_inductive_typ : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_inductive_typ _0 -> true | uu____6353 -> false
...
let (uu___is_Sig_bundle : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_bundle _0 -> true | uu____6422 -> false
...
let (uu___is_Sig_datacon : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_datacon _0 -> true | uu____6473 -> false
...
let (uu___is_Sig_declare_typ : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_declare_typ _0 -> true | uu____6534 -> false
...
let (uu___is_Sig_let : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_let _0 -> true | uu____6571 -> false
...
let (uu___is_Sig_assume : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_assume _0 -> true | uu____6608 -> false
...
let (uu___is_Sig_new_effect : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_new_effect _0 -> true | uu____6639 -> false
...
let (uu___is_Sig_sub_effect : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_sub_effect _0 -> true | uu____6652 -> false
...
let (uu___is_Sig_effect_abbrev : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_effect_abbrev _0 -> true | uu____6677 -> false
...
let (uu___is_Sig_pragma : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_pragma _0 -> true | uu____6726 -> false
...
let (uu___is_Sig_splice : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_splice _0 -> true | uu____6745 -> false
...
let (uu___is_Sig_fail : sigelt' -> Prims.bool) =
  fun projectee ->
    match projectee with | Sig_fail _0 -> true | uu____6884 -> false
...
let (contains_reflectable : qualifier Prims.list -> Prims.bool) =
  fun l ->
    FStar_Util.for_some
      (fun uu___0_7096 ->
         match uu___0_7096 with
         | Reflectable uu____7097 -> true
         | uu____7098 -> false) l
...
let (order_bv : bv -> bv -> Prims.int) =
  fun x ->
    fun y ->
      let i =
        let uu____7151 = FStar_Ident.string_of_id x.ppname in
        let uu____7152 = FStar_Ident.string_of_id y.ppname in
        FStar_String.compare uu____7151 uu____7152 in
      if i = Prims.int_zero then x.index - y.index else i
let (order_ident : FStar_Ident.ident -> FStar_Ident.ident -> Prims.int) =
  fun x ->
    fun y ->
      let uu____7164 = FStar_Ident.string_of_id x in
      let uu____7165 = FStar_Ident.string_of_id y in
      FStar_String.compare uu____7164 uu____7165
let (order_fv : FStar_Ident.lident -> FStar_Ident.lident -> Prims.int) =
  fun x ->
    fun y ->
      let uu____7176 = FStar_Ident.string_of_lid x in
      let uu____7177 = FStar_Ident.string_of_lid y in
      FStar_String.compare uu____7176 uu____7177
...
let (set_range_of_bv : bv -> FStar_Range.range -> bv) =
  fun x ->
    fun r ->
      let uu___414_7200 = x in
      let uu____7201 = FStar_Ident.set_id_range r x.ppname in
      {
        ppname = uu____7201;
        index = (uu___414_7200.index);
        sort = (uu___414_7200.sort)
      }
      ...
      let aq =
        FStar_List.map
          (fun uu____7236 ->
             ...
             | (bv1, t) -> let uu____7247 = f t in (bv1, uu____7247))
          qi.antiquotes in
      let uu___422_7248 = qi in
      { qkind = (uu___422_7248.qkind); antiquotes = aq }
  ...
  fun bv1 ->
    fun aq ->
      let uu____7263 =
        FStar_List.tryFind
          (fun uu____7281 ->
             match uu____7281 with | (bv', uu____7289) -> bv_eq bv1 bv') aq in
      match uu____7263 with
      | FStar_Pervasives_Native.Some (uu____7296, e) ->
          FStar_Pervasives_Native.Some e
      | FStar_Pervasives_Native.None -> FStar_Pervasives_Native.None
let syn :
  'uuuuuu7326 'uuuuuu7327 'uuuuuu7328 .
    'uuuuuu7326 ->
      'uuuuuu7327 ->
        ('uuuuuu7327 -> 'uuuuuu7326 -> 'uuuuuu7328) -> 'uuuuuu7328
  = fun p -> fun k -> fun f -> f k p
let mk_fvs :
  'uuuuuu7358 .
    unit -> 'uuuuuu7358 FStar_Pervasives_Native.option FStar_ST.ref
  = fun uu____7367 -> FStar_Util.mk_ref FStar_Pervasives_Native.None
let mk_uvs :
  'uuuuuu7374 .
    unit -> 'uuuuuu7374 FStar_Pervasives_Native.option FStar_ST.ref
  = fun uu____7383 -> FStar_Util.mk_ref FStar_Pervasives_Native.None
let (new_bv_set : unit -> bv FStar_Util.set) =
  fun uu____7392 -> FStar_Util.new_set order_bv
let (new_id_set : unit -> FStar_Ident.ident FStar_Util.set) =
  fun uu____7401 -> FStar_Util.new_set order_ident
let (new_fv_set : unit -> FStar_Ident.lident FStar_Util.set) =
  fun uu____7410 -> FStar_Util.new_set order_fv
let (order_univ_name : univ_name -> univ_name -> Prims.int) =
  fun x ->
    fun y ->
      let uu____7423 = FStar_Ident.string_of_id x in
      let uu____7424 = FStar_Ident.string_of_id y in
      FStar_String.compare uu____7423 uu____7424
let (new_universe_names_set : unit -> univ_name FStar_Util.set) =
  fun uu____7431 -> FStar_Util.new_set order_univ_name
let (eq_binding : binding -> binding -> Prims.bool) =
  fun b1 ->
    fun b2 ->
      match (b1, b2) with
      | (Binding_var bv1, Binding_var bv2) -> bv_eq bv1 bv2
      | (Binding_lid (lid1, uu____7447), Binding_lid (lid2, uu____7449)) ->
...
let mk : 'a . 'a -> FStar_Range.range -> 'a syntax =
  fun t ->
    fun r ->
      let uu____7530 = FStar_Util.mk_ref FStar_Pervasives_Native.None in
      { n = t; pos = r; vars = uu____7530 }
let (bv_to_tm : bv -> term) =
  fun bv1 -> let uu____7540 = range_of_bv bv1 in mk (Tm_bvar bv1) uu____7540
let (bv_to_name : bv -> term) =
  fun bv1 -> let uu____7546 = range_of_bv bv1 in mk (Tm_name bv1) uu____7546
let (binders_to_names : binders -> term Prims.list) =
  fun bs ->
    FStar_All.pipe_right bs
      (FStar_List.map
         (fun uu____7575 ->
            match uu____7575 with | (x, uu____7583) -> bv_to_name x))
let (mk_Tm_app : term -> args -> FStar_Range.range -> term) =
  fun t1 ->
    fun args1 ->
      fun p ->
        match args1 with | [] -> t1 | uu____7605 -> mk (Tm_app (t1, args1)) p
let (mk_Tm_uinst : term -> universes -> term) =
  fun t ->
    fun us ->
      ...
      | uu____7634 -> failwith "Unexpected universe instantiation"
...
let (is_type : term -> Prims.bool) =
  fun t -> match t.n with | Tm_type uu____7898 -> true | uu____7899 -> false
...
let (null_binder : term -> binder) =
  fun t ->
    let uu____7917 = null_bv t in (uu____7917, FStar_Pervasives_Native.None)
...
let (is_null_bv : bv -> Prims.bool) =
  fun b ->
    let uu____7943 = FStar_Ident.string_of_id b.ppname in
    let uu____7944 = FStar_Ident.string_of_id null_id in
    uu____7943 = uu____7944
...
let (is_top_level : letbinding Prims.list -> Prims.bool) =
  fun uu___1_7958 ->
    match uu___1_7958 with
    | { lbname = FStar_Util.Inr uu____7961; lbunivs = uu____7962;
        lbtyp = uu____7963; lbeff = uu____7964; lbdef = uu____7965;
        lbattrs = uu____7966; lbpos = uu____7967;_}::uu____7968 -> true
    | uu____7981 -> false
    ...
    FStar_List.fold_right
      (fun uu____8001 ->
         fun out ->
           ...
           | (x, uu____8014) -> FStar_Util.set_add x out) bs no_names
...
let (binders_of_freenames : freenames -> binders) =
  fun fvs ->
    let uu____8045 = FStar_Util.set_elements fvs in
    FStar_All.pipe_right uu____8045 binders_of_list
let (is_implicit : aqual -> Prims.bool) =
  fun uu___2_8054 ->
    match uu___2_8054 with
    | FStar_Pervasives_Native.Some (Implicit uu____8055) -> true
    | uu____8056 -> false
let (is_implicit_or_meta : aqual -> Prims.bool) =
  fun uu___3_8061 ->
    match uu___3_8061 with
    | FStar_Pervasives_Native.Some (Implicit uu____8062) -> true
    | FStar_Pervasives_Native.Some (Meta uu____8063) -> true
    | uu____8064 -> false
...
let (pat_bvs : pat -> bv Prims.list) =
  fun p ->
    let rec aux b p1 =
      match p1.v with
      | Pat_dot_term uu____8103 -> b
      | Pat_constant uu____8110 -> b
      | Pat_wild x -> x :: b
      | Pat_var x -> x :: b
      | Pat_cons (uu____8113, pats) ->
          FStar_List.fold_left
            (fun b1 ->
               fun uu____8144 ->
                 match uu____8144 with | (p2, uu____8156) -> aux b1 p2) b
            pats in
    let uu____8161 = aux [] p in
    FStar_All.pipe_left FStar_List.rev uu____8161
let (range_of_ropt :
  FStar_Range.range FStar_Pervasives_Native.option -> FStar_Range.range) =
  fun uu___5_8174 ->
    match uu___5_8174 with
  ...
  fun s ->
    fun r ->
      fun t ->
        ...
        let uu____8209 = FStar_Ident.next_id () in
        { ppname = id; index = uu____8209; sort = t }
...
let (freshen_bv : bv -> bv) =
  fun bv1 ->
    let uu____8229 = is_null_bv bv1 in
    if uu____8229
    then
      let uu____8230 =
        let uu____8233 = range_of_bv bv1 in
        FStar_Pervasives_Native.Some uu____8233 in
      new_bv uu____8230 bv1.sort
    else
      (let uu___608_8235 = bv1 in
       let uu____8236 = FStar_Ident.next_id () in
       {
         ppname = (uu___608_8235.ppname);
         index = uu____8236;
         sort = (uu___608_8235.sort)
       })
let (freshen_binder : binder -> binder) =
  fun b ->
    let uu____8242 = b in
    match uu____8242 with
    | (bv1, aq) -> let uu____8249 = freshen_bv bv1 in (uu____8249, aq)
let (new_univ_name :
  ...
  fun ropt ->
    ...
    let uu____8262 =
      let uu____8267 =
        let uu____8268 = FStar_Util.string_of_int id in
        Prims.op_Hat FStar_Ident.reserved_prefix uu____8268 in
      (uu____8267, (range_of_ropt ropt)) in
    FStar_Ident.mk_ident uu____8262
let (lbname_eq :
...
let (set_bv_range : bv -> FStar_Range.range -> bv) =
  fun bv1 ->
    fun r ->
      let uu___635_8366 = bv1 in
      let uu____8367 = FStar_Ident.set_id_range r bv1.ppname in
      {
        ppname = uu____8367;
        index = (uu___635_8366.index);
        sort = (uu___635_8366.sort)
      }
let (lid_as_fv :
  FStar_Ident.lident ->
  ...
  fun l ->
    fun dd ->
      fun dq ->
        let uu____8387 =
          let uu____8388 = FStar_Ident.range_of_lid l in
          withinfo l uu____8388 in
        { fv_name = uu____8387; fv_delta = dd; fv_qual = dq }
let (fv_to_tm : fv -> term) =
  fun fv1 ->
    let uu____8394 = FStar_Ident.range_of_lid (fv1.fv_name).v in
    mk (Tm_fvar fv1) uu____8394
let (fvar :
  FStar_Ident.lident ->
  ...
  fun l ->
    fun dd ->
      fun dq -> let uu____8414 = lid_as_fv l dd dq in fv_to_tm uu____8414
let (lid_of_fv : fv -> FStar_Ident.lid) = fun fv1 -> (fv1.fv_name).v
let (range_of_fv : fv -> FStar_Range.range) =
  fun fv1 ->
    let uu____8425 = lid_of_fv fv1 in FStar_Ident.range_of_lid uu____8425
let (set_range_of_fv : fv -> FStar_Range.range -> fv) =
  fun fv1 ->
    fun r ->
      let uu___648_8436 = fv1 in
      let uu____8437 =
        let uu___650_8438 = fv1.fv_name in
        let uu____8439 =
          let uu____8440 = lid_of_fv fv1 in
          FStar_Ident.set_lid_range uu____8440 r in
        { v = uu____8439; p = (uu___650_8438.p) } in
      {
        fv_name = uu____8437;
        fv_delta = (uu___648_8436.fv_delta);
        fv_qual = (uu___648_8436.fv_qual)
      }
let (has_simple_attribute : term Prims.list -> Prims.string -> Prims.bool) =
  fun l ->
    fun s ->
      FStar_List.existsb
        (fun uu___6_8462 ->
           match uu___6_8462 with
           | { n = Tm_constant (FStar_Const.Const_string (data, uu____8466));
               pos = uu____8467; vars = uu____8468;_} when data = s -> true
           | uu____8471 -> false) l
  ...
  fun p1 ->
    fun p2 ->
      ...
      | (Pat_cons (fv1, as1), Pat_cons (fv2, as2)) ->
          let uu____8522 = fv_eq fv1 fv2 in
          if uu____8522
          then
            let uu____8524 = FStar_List.zip as1 as2 in
      ...
      | (Pat_var uu____8608, Pat_var uu____8609) -> true
      | (Pat_wild uu____8610, Pat_wild uu____8611) -> true
      | (Pat_dot_term (bv1, t1), Pat_dot_term (bv2, t2)) -> true
      | (uu____8624, uu____8625) -> false
...
let (tconst : FStar_Ident.lident -> term) =
  fun l ->
    let uu____8636 = let uu____8637 = fvconst l in Tm_fvar uu____8637 in
    mk uu____8636 FStar_Range.dummyRange
let (tabbrev : FStar_Ident.lident -> term) =
  fun l ->
    let uu____8643 =
      ...
      Tm_fvar uu____8644 in
    mk uu____8643 FStar_Range.dummyRange
...
let (t_tac_of : term -> term -> term) =
  fun a ->
    fun b ->
      let uu____8661 =
        let uu____8662 = tabbrev FStar_Parser_Const.tac_lid in
        mk_Tm_uinst uu____8662 [U_zero; U_zero] in
      let uu____8663 =
        let uu____8664 = as_arg a in
        let uu____8673 = let uu____8684 = as_arg b in [uu____8684] in
        uu____8664 :: uu____8673 in
      mk_Tm_app uu____8661 uu____8663 FStar_Range.dummyRange
let (t_tactic_of : term -> term) =
  fun t ->
    let uu____8722 =
      let uu____8723 = tabbrev FStar_Parser_Const.tactic_lid in
      mk_Tm_uinst uu____8723 [U_zero] in
    let uu____8724 = let uu____8725 = as_arg t in [uu____8725] in
    mk_Tm_app uu____8722 uu____8724 FStar_Range.dummyRange
let (t_tactic_unit : term) = t_tactic_of t_unit
let (t_list_of : term -> term) =
  fun t ->
    let uu____8755 =
      let uu____8756 = tabbrev FStar_Parser_Const.list_lid in
      mk_Tm_uinst uu____8756 [U_zero] in
    let uu____8757 = let uu____8758 = as_arg t in [uu____8758] in
    mk_Tm_app uu____8755 uu____8757 FStar_Range.dummyRange
let (t_option_of : term -> term) =
  fun t ->
    let uu____8788 =
      let uu____8789 = tabbrev FStar_Parser_Const.option_lid in
      mk_Tm_uinst uu____8789 [U_zero] in
    let uu____8790 = let uu____8791 = as_arg t in [uu____8791] in
    mk_Tm_app uu____8788 uu____8790 FStar_Range.dummyRange
let (t_tuple2_of : term -> term -> term) =
  fun t1 ->
    fun t2 ->
      let uu____8826 =
        let uu____8827 = tabbrev FStar_Parser_Const.lid_tuple2 in
        mk_Tm_uinst uu____8827 [U_zero; U_zero] in
      let uu____8828 =
        let uu____8829 = as_arg t1 in
        let uu____8838 = let uu____8849 = as_arg t2 in [uu____8849] in
        uu____8829 :: uu____8838 in
      mk_Tm_app uu____8826 uu____8828 FStar_Range.dummyRange
let (t_either_of : term -> term -> term) =
  fun t1 ->
    fun t2 ->
      let uu____8892 =
        let uu____8893 = tabbrev FStar_Parser_Const.either_lid in
        mk_Tm_uinst uu____8893 [U_zero; U_zero] in
      let uu____8894 =
        let uu____8895 = as_arg t1 in
        let uu____8904 = let uu____8915 = as_arg t2 in [uu____8915] in
        uu____8895 :: uu____8904 in
      mk_Tm_app uu____8892 uu____8894 FStar_Range.dummyRange

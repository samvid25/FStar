      ...
      | FStar_Pervasives_Native.Some ((a1, FStar_Pervasives_Native.None)::[])
          ...
          FStar_Options.with_saved_options
            (fun uu____1111 ->
               ...
               kont ())
      | uu____1119 -> failwith "ill-formed `check_with`"
let (tc_decls_knot :
  (FStar_TypeChecker_Env.env ->
     FStar_Syntax_Syntax.sigelt Prims.list ->
  ...
  fun env ->
    fun ses ->
                             ...
                             (fun s ->
                                fun se1 ->
                                  let uu____4385 =
                                    let uu____4386 =
                                      FStar_Syntax_Print.sigelt_to_string se1 in
                                    Prims.op_Hat uu____4386 "\n" in
                                  Prims.op_Hat s uu____4385) "" ses'1 in
      ...
      let process_one_decl_timed acc se =
        let uu____4436 = acc in
        match uu____4436 with
        | (uu____4455, env1) ->
            let r =
              let uu____4474 =
                let uu____4477 =
                  let uu____4478 = FStar_TypeChecker_Env.current_module env1 in
                  FStar_Ident.string_of_lid uu____4478 in
                FStar_Pervasives_Native.Some uu____4477 in
              FStar_Profiling.profile
                (fun uu____4492 -> process_one_decl acc se) uu____4474
                "FStar.TypeChecker.Tc.process_one_decl" in
            ((let uu____4494 = FStar_Options.profile_group_by_decls () in
              if uu____4494
              then
                let tag =
                  match FStar_Syntax_Util.lids_of_sigelt se with
                  | hd::uu____4497 -> FStar_Ident.string_of_lid hd
                  | uu____4500 ->
  ...
  fun env ->
    fun msg ->
      FStar_Util.atomically
        (fun uu____4620 -> FStar_TypeChecker_Env.snapshot env msg)
...
let (push_context :
  ...
  fun env ->
    fun msg ->
      let uu____4670 = snapshot_context env msg in
      FStar_Pervasives_Native.snd uu____4670
let (pop_context :
  FStar_TypeChecker_Env.env -> Prims.string -> FStar_TypeChecker_Env.env) =
  fun env ->
    fun msg ->
  ...
  fun env ->
    fun modul ->
      let verify =
        ...
        FStar_Options.should_verify uu____4724 in
      let action = if verify then "Verifying" else "Lax-checking" in
      let label =
        if modul.FStar_Syntax_Syntax.is_interface
        then "interface"
        else "implementation" in
      (let uu____4730 = FStar_Options.debug_any () in
       if uu____4730
       then
         let uu____4731 =
           FStar_Ident.string_of_lid modul.FStar_Syntax_Syntax.name in
         FStar_Util.print3 "%s %s of %s\n" action label uu____4731
       else ());
      (let name =
         let uu____4734 =
           FStar_Ident.string_of_lid modul.FStar_Syntax_Syntax.name in
         FStar_Util.format2 "%s %s"
           (if modul.FStar_Syntax_Syntax.is_interface
            then "interface"
            else "module") uu____4734 in
       let env1 =
         let uu___993_4737 = env in
         {
           FStar_TypeChecker_Env.solver =
             (uu___993_4737.FStar_TypeChecker_Env.solver);
           FStar_TypeChecker_Env.range =
             (uu___993_4737.FStar_TypeChecker_Env.range);
           FStar_TypeChecker_Env.curmodule =
             (uu___993_4737.FStar_TypeChecker_Env.curmodule);
           FStar_TypeChecker_Env.gamma =
             (uu___993_4737.FStar_TypeChecker_Env.gamma);
           FStar_TypeChecker_Env.gamma_sig =
             (uu___993_4737.FStar_TypeChecker_Env.gamma_sig);
           FStar_TypeChecker_Env.gamma_cache =
             (uu___993_4737.FStar_TypeChecker_Env.gamma_cache);
           FStar_TypeChecker_Env.modules =
             (uu___993_4737.FStar_TypeChecker_Env.modules);
           FStar_TypeChecker_Env.expected_typ =
             (uu___993_4737.FStar_TypeChecker_Env.expected_typ);
           FStar_TypeChecker_Env.sigtab =
             (uu___993_4737.FStar_TypeChecker_Env.sigtab);
           FStar_TypeChecker_Env.attrtab =
             (uu___993_4737.FStar_TypeChecker_Env.attrtab);
           FStar_TypeChecker_Env.instantiate_imp =
             (uu___993_4737.FStar_TypeChecker_Env.instantiate_imp);
           FStar_TypeChecker_Env.effects =
             (uu___993_4737.FStar_TypeChecker_Env.effects);
           FStar_TypeChecker_Env.generalize =
             (uu___993_4737.FStar_TypeChecker_Env.generalize);
           FStar_TypeChecker_Env.letrecs =
             (uu___993_4737.FStar_TypeChecker_Env.letrecs);
           FStar_TypeChecker_Env.top_level =
             (uu___993_4737.FStar_TypeChecker_Env.top_level);
           FStar_TypeChecker_Env.check_uvars =
             (uu___993_4737.FStar_TypeChecker_Env.check_uvars);
           FStar_TypeChecker_Env.use_eq =
             (uu___993_4737.FStar_TypeChecker_Env.use_eq);
           FStar_TypeChecker_Env.use_eq_strict =
             (uu___993_4737.FStar_TypeChecker_Env.use_eq_strict);
           FStar_TypeChecker_Env.is_iface =
             (modul.FStar_Syntax_Syntax.is_interface);
           FStar_TypeChecker_Env.admit = (Prims.op_Negation verify);
           FStar_TypeChecker_Env.lax =
             (uu___993_4737.FStar_TypeChecker_Env.lax);
           FStar_TypeChecker_Env.lax_universes =
             (uu___993_4737.FStar_TypeChecker_Env.lax_universes);
           FStar_TypeChecker_Env.phase1 =
             (uu___993_4737.FStar_TypeChecker_Env.phase1);
           FStar_TypeChecker_Env.failhard =
             (uu___993_4737.FStar_TypeChecker_Env.failhard);
           FStar_TypeChecker_Env.nosynth =
             (uu___993_4737.FStar_TypeChecker_Env.nosynth);
           FStar_TypeChecker_Env.uvar_subtyping =
             (uu___993_4737.FStar_TypeChecker_Env.uvar_subtyping);
           FStar_TypeChecker_Env.tc_term =
             (uu___993_4737.FStar_TypeChecker_Env.tc_term);
           FStar_TypeChecker_Env.type_of =
             (uu___993_4737.FStar_TypeChecker_Env.type_of);
           FStar_TypeChecker_Env.universe_of =
             (uu___993_4737.FStar_TypeChecker_Env.universe_of);
           FStar_TypeChecker_Env.check_type_of =
             (uu___993_4737.FStar_TypeChecker_Env.check_type_of);
           FStar_TypeChecker_Env.use_bv_sorts =
             (uu___993_4737.FStar_TypeChecker_Env.use_bv_sorts);
           FStar_TypeChecker_Env.qtbl_name_and_index =
             (uu___993_4737.FStar_TypeChecker_Env.qtbl_name_and_index);
           FStar_TypeChecker_Env.normalized_eff_names =
             (uu___993_4737.FStar_TypeChecker_Env.normalized_eff_names);
           FStar_TypeChecker_Env.fv_delta_depths =
             (uu___993_4737.FStar_TypeChecker_Env.fv_delta_depths);
           FStar_TypeChecker_Env.proof_ns =
             (uu___993_4737.FStar_TypeChecker_Env.proof_ns);
           FStar_TypeChecker_Env.synth_hook =
             (uu___993_4737.FStar_TypeChecker_Env.synth_hook);
           FStar_TypeChecker_Env.try_solve_implicits_hook =
             (uu___993_4737.FStar_TypeChecker_Env.try_solve_implicits_hook);
           FStar_TypeChecker_Env.splice =
             (uu___993_4737.FStar_TypeChecker_Env.splice);
           FStar_TypeChecker_Env.mpreprocess =
             (uu___993_4737.FStar_TypeChecker_Env.mpreprocess);
           FStar_TypeChecker_Env.postprocess =
             (uu___993_4737.FStar_TypeChecker_Env.postprocess);
           FStar_TypeChecker_Env.identifier_info =
             (uu___993_4737.FStar_TypeChecker_Env.identifier_info);
           FStar_TypeChecker_Env.tc_hooks =
             (uu___993_4737.FStar_TypeChecker_Env.tc_hooks);
           FStar_TypeChecker_Env.dsenv =
             (uu___993_4737.FStar_TypeChecker_Env.dsenv);
           FStar_TypeChecker_Env.nbe =
             (uu___993_4737.FStar_TypeChecker_Env.nbe);
           FStar_TypeChecker_Env.strict_args_tab =
             (uu___993_4737.FStar_TypeChecker_Env.strict_args_tab);
           FStar_TypeChecker_Env.erasable_types_tab =
             (uu___993_4737.FStar_TypeChecker_Env.erasable_types_tab);
           FStar_TypeChecker_Env.enable_defer_to_tac =
             (uu___993_4737.FStar_TypeChecker_Env.enable_defer_to_tac)
         } in
       let env2 =
         FStar_TypeChecker_Env.set_current_module env1
           modul.FStar_Syntax_Syntax.name in
       let uu____4739 = tc_decls env2 modul.FStar_Syntax_Syntax.declarations in
       match uu____4739 with
       | (ses, env3) ->
           ((let uu___1000_4757 = modul in
             {
               FStar_Syntax_Syntax.name =
                 (uu___1000_4757.FStar_Syntax_Syntax.name);
               FStar_Syntax_Syntax.declarations = ses;
               FStar_Syntax_Syntax.is_interface =
                 (uu___1000_4757.FStar_Syntax_Syntax.is_interface)
             }), env3))
let (tc_more_partial_modul :
  ...
  fun env ->
    fun modul ->
      fun decls ->
        let uu____4785 = tc_decls env decls in
        match uu____4785 with
        | (ses, env1) ->
            let modul1 =
              let uu___1008_4807 = modul in
              {
                FStar_Syntax_Syntax.name =
                  (uu___1008_4807.FStar_Syntax_Syntax.name);
                FStar_Syntax_Syntax.declarations =
                  (FStar_List.append modul.FStar_Syntax_Syntax.declarations
                     ses);
                FStar_Syntax_Syntax.is_interface =
                  (uu___1008_4807.FStar_Syntax_Syntax.is_interface)
              } in
            (modul1, ses, env1)
        ...
        fun m ->
          ...
          (let uu____4840 =
             FStar_All.pipe_right
               ...
               FStar_Pervasives_Native.fst in
           FStar_All.pipe_right uu____4840 FStar_Util.smap_clear);
          (let uu____4868 =
             let uu____4869 =
               let uu____4870 =
                 FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name in
               Prims.op_Hat "Ending modul " uu____4870 in
             pop_context env uu____4869 in
           FStar_All.pipe_right uu____4868 (fun uu____4871 -> ()));
          (m, env)
let (tc_modul :
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.modul ->
    ...
    fun m ->
      fun iface_exists ->
        let uu____4895 =
          let uu____4896 =
            FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name in
          FStar_Util.format1 "While checking module %s" uu____4896 in
        FStar_Errors.with_ctx uu____4895
          (fun uu____4907 ->
             let msg =
               let uu____4909 =
                 FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name in
               Prims.op_Hat "Internals for " uu____4909 in
             let env01 = push_context env0 msg in
             let uu____4911 = tc_partial_modul env01 m in
    ...
    fun m ->
      ...
      let env1 =
        let uu____4934 =
          let uu____4935 =
            FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name in
          Prims.op_Hat "Internals for " uu____4935 in
        push_context env uu____4934 in
      let env2 =
        FStar_List.fold_left
          (fun env2 ->
             fun se ->
      ...
      let uu____4957 = finish_partial_modul true true env2 m in
      match uu____4957 with | (uu____4962, env3) -> env3
let (check_module :
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.modul ->
      Prims.bool -> (FStar_Syntax_Syntax.modul * FStar_TypeChecker_Env.env))
         ...
         then
           ...
           FStar_Util.print2 "Checking %s: %s\n"
             (if m.FStar_Syntax_Syntax.is_interface
              then "i'face"
              else "module") uu____4985
         else ());
        (let uu____4989 =
           let uu____4990 =
             FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name in
           FStar_Options.dump_module uu____4990 in
         if uu____4989
         then
           let uu____4991 = FStar_Syntax_Print.modul_to_string m in
           FStar_Util.print1 "Module before type checking:\n%s\n" uu____4991
         else ());
        (let env1 =
           let uu___1049_4994 = env in
           let uu____4995 =
             let uu____4996 =
               let uu____4997 =
                 FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name in
               FStar_Options.should_verify uu____4997 in
             Prims.op_Negation uu____4996 in
           {
             FStar_TypeChecker_Env.solver =
               (uu___1049_4994.FStar_TypeChecker_Env.solver);
             FStar_TypeChecker_Env.range =
               (uu___1049_4994.FStar_TypeChecker_Env.range);
             FStar_TypeChecker_Env.curmodule =
               (uu___1049_4994.FStar_TypeChecker_Env.curmodule);
             FStar_TypeChecker_Env.gamma =
               (uu___1049_4994.FStar_TypeChecker_Env.gamma);
             FStar_TypeChecker_Env.gamma_sig =
               (uu___1049_4994.FStar_TypeChecker_Env.gamma_sig);
             FStar_TypeChecker_Env.gamma_cache =
               (uu___1049_4994.FStar_TypeChecker_Env.gamma_cache);
             FStar_TypeChecker_Env.modules =
               (uu___1049_4994.FStar_TypeChecker_Env.modules);
             FStar_TypeChecker_Env.expected_typ =
               (uu___1049_4994.FStar_TypeChecker_Env.expected_typ);
             FStar_TypeChecker_Env.sigtab =
               (uu___1049_4994.FStar_TypeChecker_Env.sigtab);
             FStar_TypeChecker_Env.attrtab =
               (uu___1049_4994.FStar_TypeChecker_Env.attrtab);
             FStar_TypeChecker_Env.instantiate_imp =
               (uu___1049_4994.FStar_TypeChecker_Env.instantiate_imp);
             FStar_TypeChecker_Env.effects =
               (uu___1049_4994.FStar_TypeChecker_Env.effects);
             FStar_TypeChecker_Env.generalize =
               (uu___1049_4994.FStar_TypeChecker_Env.generalize);
             FStar_TypeChecker_Env.letrecs =
               (uu___1049_4994.FStar_TypeChecker_Env.letrecs);
             FStar_TypeChecker_Env.top_level =
               (uu___1049_4994.FStar_TypeChecker_Env.top_level);
             FStar_TypeChecker_Env.check_uvars =
               (uu___1049_4994.FStar_TypeChecker_Env.check_uvars);
             FStar_TypeChecker_Env.use_eq =
               (uu___1049_4994.FStar_TypeChecker_Env.use_eq);
             FStar_TypeChecker_Env.use_eq_strict =
               (uu___1049_4994.FStar_TypeChecker_Env.use_eq_strict);
             FStar_TypeChecker_Env.is_iface =
               (uu___1049_4994.FStar_TypeChecker_Env.is_iface);
             FStar_TypeChecker_Env.admit =
               (uu___1049_4994.FStar_TypeChecker_Env.admit);
             FStar_TypeChecker_Env.lax = uu____4995;
             FStar_TypeChecker_Env.lax_universes =
               (uu___1049_4994.FStar_TypeChecker_Env.lax_universes);
             FStar_TypeChecker_Env.phase1 =
               (uu___1049_4994.FStar_TypeChecker_Env.phase1);
             FStar_TypeChecker_Env.failhard =
               (uu___1049_4994.FStar_TypeChecker_Env.failhard);
             FStar_TypeChecker_Env.nosynth =
               (uu___1049_4994.FStar_TypeChecker_Env.nosynth);
             FStar_TypeChecker_Env.uvar_subtyping =
               (uu___1049_4994.FStar_TypeChecker_Env.uvar_subtyping);
             FStar_TypeChecker_Env.tc_term =
               (uu___1049_4994.FStar_TypeChecker_Env.tc_term);
             FStar_TypeChecker_Env.type_of =
               (uu___1049_4994.FStar_TypeChecker_Env.type_of);
             FStar_TypeChecker_Env.universe_of =
               (uu___1049_4994.FStar_TypeChecker_Env.universe_of);
             FStar_TypeChecker_Env.check_type_of =
               (uu___1049_4994.FStar_TypeChecker_Env.check_type_of);
             FStar_TypeChecker_Env.use_bv_sorts =
               (uu___1049_4994.FStar_TypeChecker_Env.use_bv_sorts);
             FStar_TypeChecker_Env.qtbl_name_and_index =
               (uu___1049_4994.FStar_TypeChecker_Env.qtbl_name_and_index);
             FStar_TypeChecker_Env.normalized_eff_names =
               (uu___1049_4994.FStar_TypeChecker_Env.normalized_eff_names);
             FStar_TypeChecker_Env.fv_delta_depths =
               (uu___1049_4994.FStar_TypeChecker_Env.fv_delta_depths);
             FStar_TypeChecker_Env.proof_ns =
               (uu___1049_4994.FStar_TypeChecker_Env.proof_ns);
             FStar_TypeChecker_Env.synth_hook =
               (uu___1049_4994.FStar_TypeChecker_Env.synth_hook);
             FStar_TypeChecker_Env.try_solve_implicits_hook =
               (uu___1049_4994.FStar_TypeChecker_Env.try_solve_implicits_hook);
             FStar_TypeChecker_Env.splice =
               (uu___1049_4994.FStar_TypeChecker_Env.splice);
             FStar_TypeChecker_Env.mpreprocess =
               (uu___1049_4994.FStar_TypeChecker_Env.mpreprocess);
             FStar_TypeChecker_Env.postprocess =
               (uu___1049_4994.FStar_TypeChecker_Env.postprocess);
             FStar_TypeChecker_Env.identifier_info =
               (uu___1049_4994.FStar_TypeChecker_Env.identifier_info);
             FStar_TypeChecker_Env.tc_hooks =
               (uu___1049_4994.FStar_TypeChecker_Env.tc_hooks);
             FStar_TypeChecker_Env.dsenv =
               (uu___1049_4994.FStar_TypeChecker_Env.dsenv);
             FStar_TypeChecker_Env.nbe =
               (uu___1049_4994.FStar_TypeChecker_Env.nbe);
             FStar_TypeChecker_Env.strict_args_tab =
               (uu___1049_4994.FStar_TypeChecker_Env.strict_args_tab);
             FStar_TypeChecker_Env.erasable_types_tab =
               (uu___1049_4994.FStar_TypeChecker_Env.erasable_types_tab);
             FStar_TypeChecker_Env.enable_defer_to_tac =
               (uu___1049_4994.FStar_TypeChecker_Env.enable_defer_to_tac)
           } in
         let uu____4998 = tc_modul env1 m b in
         match uu____4998 with
         | (m1, env2) ->
             ((let uu____5010 =
                 let uu____5011 =
                   FStar_Ident.string_of_lid m1.FStar_Syntax_Syntax.name in
                 FStar_Options.dump_module uu____5011 in
               if uu____5010
               then
                 let uu____5012 = FStar_Syntax_Print.modul_to_string m1 in
              ...
              (let uu____5015 =
                 (let uu____5018 =
                    FStar_Ident.string_of_lid m1.FStar_Syntax_Syntax.name in
                  FStar_Options.dump_module uu____5018) &&
                   (let uu____5020 =
                      FStar_Ident.string_of_lid m1.FStar_Syntax_Syntax.name in
                    FStar_Options.debug_at_level uu____5020
                   ...
                   | FStar_Syntax_Syntax.Sig_let ((b1, lbs), ids) ->
                       ...
                       let update lb =
                         ...
                         | (univnames, e) ->
                             ...
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___1071_5060.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs =
                                 (uu___1071_5060.FStar_Syntax_Syntax.lbunivs);
                               FStar_Syntax_Syntax.lbtyp =
                                 (uu___1071_5060.FStar_Syntax_Syntax.lbtyp);
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___1071_5060.FStar_Syntax_Syntax.lbeff);
                               FStar_Syntax_Syntax.lbdef = uu____5061;
                               FStar_Syntax_Syntax.lbattrs =
                                 (uu___1071_5060.FStar_Syntax_Syntax.lbattrs);
                               FStar_Syntax_Syntax.lbpos =
                                 (uu___1071_5060.FStar_Syntax_Syntax.lbpos)
                             } in
                       let uu___1073_5065 = se in
                       let uu____5066 =
                         let uu____5067 =
                           let uu____5074 =
                             let uu____5075 = FStar_List.map update lbs in
                             (b1, uu____5075) in
                           (uu____5074, ids) in
                         FStar_Syntax_Syntax.Sig_let uu____5067 in
                       {
                         FStar_Syntax_Syntax.sigel = uu____5066;
                         FStar_Syntax_Syntax.sigrng =
                           (uu___1073_5065.FStar_Syntax_Syntax.sigrng);
                         FStar_Syntax_Syntax.sigquals =
                           (uu___1073_5065.FStar_Syntax_Syntax.sigquals);
                         FStar_Syntax_Syntax.sigmeta =
                           (uu___1073_5065.FStar_Syntax_Syntax.sigmeta);
                         FStar_Syntax_Syntax.sigattrs =
                           (uu___1073_5065.FStar_Syntax_Syntax.sigattrs);
                         FStar_Syntax_Syntax.sigopts =
                           (uu___1073_5065.FStar_Syntax_Syntax.sigopts)
                       }
                   | uu____5082 -> se in
                 let normalized_module =
                   let uu___1077_5084 = m1 in
                   let uu____5085 =
                     FStar_List.map normalize_toplevel_lets
                       m1.FStar_Syntax_Syntax.declarations in
                   {
                     FStar_Syntax_Syntax.name =
                       (uu___1077_5084.FStar_Syntax_Syntax.name);
                     FStar_Syntax_Syntax.declarations = uu____5085;
                     FStar_Syntax_Syntax.is_interface =
                       (uu___1077_5084.FStar_Syntax_Syntax.is_interface)
                   } in
                 let uu____5086 =

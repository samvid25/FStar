  ...
  fun env ->
    fun ses ->
               ...
               (let uu____4294 =
                  let uu____4305 =
                    ...
                    FStar_Util.format1
                      ...
                      uu____4306 in
                  FStar_Errors.with_ctx uu____4305
                    (fun uu____4318 -> tc_decl env1 se) in
                             ...
                             (fun s ->
                                fun se1 ->
                                  let uu____4389 =
                                    let uu____4390 =
                                      FStar_Syntax_Print.sigelt_to_string se1 in
                                    Prims.op_Hat uu____4390 "\n" in
                                  Prims.op_Hat s uu____4389) "" ses'1 in
      ...
      let process_one_decl_timed acc se =
        let uu____4440 = acc in
        match uu____4440 with
        | (uu____4459, env1) ->
            let r =
              let uu____4478 =
                let uu____4481 =
                  let uu____4482 = FStar_TypeChecker_Env.current_module env1 in
                  FStar_Ident.string_of_lid uu____4482 in
                FStar_Pervasives_Native.Some uu____4481 in
              FStar_Profiling.profile
                (fun uu____4496 -> process_one_decl acc se) uu____4478
                "FStar.TypeChecker.Tc.process_one_decl" in
            ((let uu____4498 = FStar_Options.profile_group_by_decls () in
              if uu____4498
              then
                let tag =
                  match FStar_Syntax_Util.lids_of_sigelt se with
                  | hd::uu____4501 -> FStar_Ident.string_of_lid hd
                  | uu____4504 ->
  ...
  fun env ->
    fun msg ->
      FStar_Util.atomically
        (fun uu____4624 -> FStar_TypeChecker_Env.snapshot env msg)
...
let (push_context :
  ...
  fun env ->
    fun msg ->
      let uu____4674 = snapshot_context env msg in
      FStar_Pervasives_Native.snd uu____4674
let (pop_context :
  FStar_TypeChecker_Env.env -> Prims.string -> FStar_TypeChecker_Env.env) =
  fun env ->
    fun msg ->
  ...
  fun env ->
    fun modul ->
      let verify =
        ...
        FStar_Options.should_verify uu____4728 in
      let action = if verify then "Verifying" else "Lax-checking" in
      let label =
        if modul.FStar_Syntax_Syntax.is_interface
        then "interface"
        else "implementation" in
      (let uu____4734 = FStar_Options.debug_any () in
       if uu____4734
       then
         let uu____4735 =
           FStar_Ident.string_of_lid modul.FStar_Syntax_Syntax.name in
         FStar_Util.print3 "%s %s of %s\n" action label uu____4735
       else ());
      (let name =
         let uu____4738 =
           FStar_Ident.string_of_lid modul.FStar_Syntax_Syntax.name in
         FStar_Util.format2 "%s %s"
           (if modul.FStar_Syntax_Syntax.is_interface
            then "interface"
            else "module") uu____4738 in
       let env1 =
         let uu___993_4741 = env in
         {
           FStar_TypeChecker_Env.solver =
             (uu___993_4741.FStar_TypeChecker_Env.solver);
           FStar_TypeChecker_Env.range =
             (uu___993_4741.FStar_TypeChecker_Env.range);
           FStar_TypeChecker_Env.curmodule =
             (uu___993_4741.FStar_TypeChecker_Env.curmodule);
           FStar_TypeChecker_Env.gamma =
             (uu___993_4741.FStar_TypeChecker_Env.gamma);
           FStar_TypeChecker_Env.gamma_sig =
             (uu___993_4741.FStar_TypeChecker_Env.gamma_sig);
           FStar_TypeChecker_Env.gamma_cache =
             (uu___993_4741.FStar_TypeChecker_Env.gamma_cache);
           FStar_TypeChecker_Env.modules =
             (uu___993_4741.FStar_TypeChecker_Env.modules);
           FStar_TypeChecker_Env.expected_typ =
             (uu___993_4741.FStar_TypeChecker_Env.expected_typ);
           FStar_TypeChecker_Env.sigtab =
             (uu___993_4741.FStar_TypeChecker_Env.sigtab);
           FStar_TypeChecker_Env.attrtab =
             (uu___993_4741.FStar_TypeChecker_Env.attrtab);
           FStar_TypeChecker_Env.instantiate_imp =
             (uu___993_4741.FStar_TypeChecker_Env.instantiate_imp);
           FStar_TypeChecker_Env.effects =
             (uu___993_4741.FStar_TypeChecker_Env.effects);
           FStar_TypeChecker_Env.generalize =
             (uu___993_4741.FStar_TypeChecker_Env.generalize);
           FStar_TypeChecker_Env.letrecs =
             (uu___993_4741.FStar_TypeChecker_Env.letrecs);
           FStar_TypeChecker_Env.top_level =
             (uu___993_4741.FStar_TypeChecker_Env.top_level);
           FStar_TypeChecker_Env.check_uvars =
             (uu___993_4741.FStar_TypeChecker_Env.check_uvars);
           FStar_TypeChecker_Env.use_eq =
             (uu___993_4741.FStar_TypeChecker_Env.use_eq);
           FStar_TypeChecker_Env.use_eq_strict =
             (uu___993_4741.FStar_TypeChecker_Env.use_eq_strict);
           FStar_TypeChecker_Env.is_iface =
             (modul.FStar_Syntax_Syntax.is_interface);
           FStar_TypeChecker_Env.admit = (Prims.op_Negation verify);
           FStar_TypeChecker_Env.lax =
             (uu___993_4741.FStar_TypeChecker_Env.lax);
           FStar_TypeChecker_Env.lax_universes =
             (uu___993_4741.FStar_TypeChecker_Env.lax_universes);
           FStar_TypeChecker_Env.phase1 =
             (uu___993_4741.FStar_TypeChecker_Env.phase1);
           FStar_TypeChecker_Env.failhard =
             (uu___993_4741.FStar_TypeChecker_Env.failhard);
           FStar_TypeChecker_Env.nosynth =
             (uu___993_4741.FStar_TypeChecker_Env.nosynth);
           FStar_TypeChecker_Env.uvar_subtyping =
             (uu___993_4741.FStar_TypeChecker_Env.uvar_subtyping);
           FStar_TypeChecker_Env.tc_term =
             (uu___993_4741.FStar_TypeChecker_Env.tc_term);
           FStar_TypeChecker_Env.type_of =
             (uu___993_4741.FStar_TypeChecker_Env.type_of);
           FStar_TypeChecker_Env.universe_of =
             (uu___993_4741.FStar_TypeChecker_Env.universe_of);
           FStar_TypeChecker_Env.check_type_of =
             (uu___993_4741.FStar_TypeChecker_Env.check_type_of);
           FStar_TypeChecker_Env.use_bv_sorts =
             (uu___993_4741.FStar_TypeChecker_Env.use_bv_sorts);
           FStar_TypeChecker_Env.qtbl_name_and_index =
             (uu___993_4741.FStar_TypeChecker_Env.qtbl_name_and_index);
           FStar_TypeChecker_Env.normalized_eff_names =
             (uu___993_4741.FStar_TypeChecker_Env.normalized_eff_names);
           FStar_TypeChecker_Env.fv_delta_depths =
             (uu___993_4741.FStar_TypeChecker_Env.fv_delta_depths);
           FStar_TypeChecker_Env.proof_ns =
             (uu___993_4741.FStar_TypeChecker_Env.proof_ns);
           FStar_TypeChecker_Env.synth_hook =
             (uu___993_4741.FStar_TypeChecker_Env.synth_hook);
           FStar_TypeChecker_Env.try_solve_implicits_hook =
             (uu___993_4741.FStar_TypeChecker_Env.try_solve_implicits_hook);
           FStar_TypeChecker_Env.splice =
             (uu___993_4741.FStar_TypeChecker_Env.splice);
           FStar_TypeChecker_Env.mpreprocess =
             (uu___993_4741.FStar_TypeChecker_Env.mpreprocess);
           FStar_TypeChecker_Env.postprocess =
             (uu___993_4741.FStar_TypeChecker_Env.postprocess);
           FStar_TypeChecker_Env.identifier_info =
             (uu___993_4741.FStar_TypeChecker_Env.identifier_info);
           FStar_TypeChecker_Env.tc_hooks =
             (uu___993_4741.FStar_TypeChecker_Env.tc_hooks);
           FStar_TypeChecker_Env.dsenv =
             (uu___993_4741.FStar_TypeChecker_Env.dsenv);
           FStar_TypeChecker_Env.nbe =
             (uu___993_4741.FStar_TypeChecker_Env.nbe);
           FStar_TypeChecker_Env.strict_args_tab =
             (uu___993_4741.FStar_TypeChecker_Env.strict_args_tab);
           FStar_TypeChecker_Env.erasable_types_tab =
             (uu___993_4741.FStar_TypeChecker_Env.erasable_types_tab);
           FStar_TypeChecker_Env.enable_defer_to_tac =
             (uu___993_4741.FStar_TypeChecker_Env.enable_defer_to_tac)
         } in
       let env2 =
         FStar_TypeChecker_Env.set_current_module env1
           modul.FStar_Syntax_Syntax.name in
       let uu____4743 = tc_decls env2 modul.FStar_Syntax_Syntax.declarations in
       match uu____4743 with
       | (ses, env3) ->
           ((let uu___1000_4761 = modul in
             {
               FStar_Syntax_Syntax.name =
                 (uu___1000_4761.FStar_Syntax_Syntax.name);
               FStar_Syntax_Syntax.declarations = ses;
               FStar_Syntax_Syntax.is_interface =
                 (uu___1000_4761.FStar_Syntax_Syntax.is_interface)
             }), env3))
let (tc_more_partial_modul :
  ...
  fun env ->
    fun modul ->
      fun decls ->
        let uu____4789 = tc_decls env decls in
        match uu____4789 with
        | (ses, env1) ->
            let modul1 =
              let uu___1008_4811 = modul in
              {
                FStar_Syntax_Syntax.name =
                  (uu___1008_4811.FStar_Syntax_Syntax.name);
                FStar_Syntax_Syntax.declarations =
                  (FStar_List.append modul.FStar_Syntax_Syntax.declarations
                     ses);
                FStar_Syntax_Syntax.is_interface =
                  (uu___1008_4811.FStar_Syntax_Syntax.is_interface)
              } in
            (modul1, ses, env1)
        ...
        fun m ->
          ...
          (let uu____4844 =
             FStar_All.pipe_right
               ...
               FStar_Pervasives_Native.fst in
           FStar_All.pipe_right uu____4844 FStar_Util.smap_clear);
          (let uu____4872 =
             let uu____4873 =
               let uu____4874 =
                 FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name in
               Prims.op_Hat "Ending modul " uu____4874 in
             pop_context env uu____4873 in
           FStar_All.pipe_right uu____4872 (fun uu____4875 -> ()));
          (m, env)
let (tc_modul :
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.modul ->
    ...
    fun m ->
      fun iface_exists ->
        let msg =
          let uu____4900 =
            FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name in
          Prims.op_Hat "Internals for " uu____4900 in
        let env01 = push_context env0 msg in
        let uu____4902 = tc_partial_modul env01 m in
    ...
    fun m ->
      ...
      let env1 =
        let uu____4925 =
          let uu____4926 =
            FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name in
          Prims.op_Hat "Internals for " uu____4926 in
        push_context env uu____4925 in
      let env2 =
        FStar_List.fold_left
          (fun env2 ->
             fun se ->
      ...
      let uu____4948 = finish_partial_modul true true env2 m in
      match uu____4948 with | (uu____4953, env3) -> env3
let (check_module :
  FStar_TypeChecker_Env.env ->
    FStar_Syntax_Syntax.modul ->
      Prims.bool -> (FStar_Syntax_Syntax.modul * FStar_TypeChecker_Env.env))
  ...
  fun env ->
    fun m ->
      fun b ->
        (let uu____4975 = FStar_Options.debug_any () in
         if uu____4975
         then
           let uu____4976 =
           ...
           FStar_Util.print2 "Checking %s: %s\n"
             (if m.FStar_Syntax_Syntax.is_interface
              then "i'face"
              else "module") uu____4976
         else ());
        (let uu____4980 =
           let uu____4981 =
             FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name in
           FStar_Options.dump_module uu____4981 in
         if uu____4980
         then
           let uu____4982 = FStar_Syntax_Print.modul_to_string m in
           FStar_Util.print1 "Module before type checking:\n%s\n" uu____4982
         else ());
        (let env1 =
           let uu___1048_4985 = env in
           let uu____4986 =
             let uu____4987 =
               let uu____4988 =
                 FStar_Ident.string_of_lid m.FStar_Syntax_Syntax.name in
               FStar_Options.should_verify uu____4988 in
             Prims.op_Negation uu____4987 in
           {
             FStar_TypeChecker_Env.solver =
               (uu___1048_4985.FStar_TypeChecker_Env.solver);
             FStar_TypeChecker_Env.range =
               (uu___1048_4985.FStar_TypeChecker_Env.range);
             FStar_TypeChecker_Env.curmodule =
               (uu___1048_4985.FStar_TypeChecker_Env.curmodule);
             FStar_TypeChecker_Env.gamma =
               (uu___1048_4985.FStar_TypeChecker_Env.gamma);
             FStar_TypeChecker_Env.gamma_sig =
               (uu___1048_4985.FStar_TypeChecker_Env.gamma_sig);
             FStar_TypeChecker_Env.gamma_cache =
               (uu___1048_4985.FStar_TypeChecker_Env.gamma_cache);
             FStar_TypeChecker_Env.modules =
               (uu___1048_4985.FStar_TypeChecker_Env.modules);
             FStar_TypeChecker_Env.expected_typ =
               (uu___1048_4985.FStar_TypeChecker_Env.expected_typ);
             FStar_TypeChecker_Env.sigtab =
               (uu___1048_4985.FStar_TypeChecker_Env.sigtab);
             FStar_TypeChecker_Env.attrtab =
               (uu___1048_4985.FStar_TypeChecker_Env.attrtab);
             FStar_TypeChecker_Env.instantiate_imp =
               (uu___1048_4985.FStar_TypeChecker_Env.instantiate_imp);
             FStar_TypeChecker_Env.effects =
               (uu___1048_4985.FStar_TypeChecker_Env.effects);
             FStar_TypeChecker_Env.generalize =
               (uu___1048_4985.FStar_TypeChecker_Env.generalize);
             FStar_TypeChecker_Env.letrecs =
               (uu___1048_4985.FStar_TypeChecker_Env.letrecs);
             FStar_TypeChecker_Env.top_level =
               (uu___1048_4985.FStar_TypeChecker_Env.top_level);
             FStar_TypeChecker_Env.check_uvars =
               (uu___1048_4985.FStar_TypeChecker_Env.check_uvars);
             FStar_TypeChecker_Env.use_eq =
               (uu___1048_4985.FStar_TypeChecker_Env.use_eq);
             FStar_TypeChecker_Env.use_eq_strict =
               (uu___1048_4985.FStar_TypeChecker_Env.use_eq_strict);
             FStar_TypeChecker_Env.is_iface =
               (uu___1048_4985.FStar_TypeChecker_Env.is_iface);
             FStar_TypeChecker_Env.admit =
               (uu___1048_4985.FStar_TypeChecker_Env.admit);
             FStar_TypeChecker_Env.lax = uu____4986;
             FStar_TypeChecker_Env.lax_universes =
               (uu___1048_4985.FStar_TypeChecker_Env.lax_universes);
             FStar_TypeChecker_Env.phase1 =
               (uu___1048_4985.FStar_TypeChecker_Env.phase1);
             FStar_TypeChecker_Env.failhard =
               (uu___1048_4985.FStar_TypeChecker_Env.failhard);
             FStar_TypeChecker_Env.nosynth =
               (uu___1048_4985.FStar_TypeChecker_Env.nosynth);
             FStar_TypeChecker_Env.uvar_subtyping =
               (uu___1048_4985.FStar_TypeChecker_Env.uvar_subtyping);
             FStar_TypeChecker_Env.tc_term =
               (uu___1048_4985.FStar_TypeChecker_Env.tc_term);
             FStar_TypeChecker_Env.type_of =
               (uu___1048_4985.FStar_TypeChecker_Env.type_of);
             FStar_TypeChecker_Env.universe_of =
               (uu___1048_4985.FStar_TypeChecker_Env.universe_of);
             FStar_TypeChecker_Env.check_type_of =
               (uu___1048_4985.FStar_TypeChecker_Env.check_type_of);
             FStar_TypeChecker_Env.use_bv_sorts =
               (uu___1048_4985.FStar_TypeChecker_Env.use_bv_sorts);
             FStar_TypeChecker_Env.qtbl_name_and_index =
               (uu___1048_4985.FStar_TypeChecker_Env.qtbl_name_and_index);
             FStar_TypeChecker_Env.normalized_eff_names =
               (uu___1048_4985.FStar_TypeChecker_Env.normalized_eff_names);
             FStar_TypeChecker_Env.fv_delta_depths =
               (uu___1048_4985.FStar_TypeChecker_Env.fv_delta_depths);
             FStar_TypeChecker_Env.proof_ns =
               (uu___1048_4985.FStar_TypeChecker_Env.proof_ns);
             FStar_TypeChecker_Env.synth_hook =
               (uu___1048_4985.FStar_TypeChecker_Env.synth_hook);
             FStar_TypeChecker_Env.try_solve_implicits_hook =
               (uu___1048_4985.FStar_TypeChecker_Env.try_solve_implicits_hook);
             FStar_TypeChecker_Env.splice =
               (uu___1048_4985.FStar_TypeChecker_Env.splice);
             FStar_TypeChecker_Env.mpreprocess =
               (uu___1048_4985.FStar_TypeChecker_Env.mpreprocess);
             FStar_TypeChecker_Env.postprocess =
               (uu___1048_4985.FStar_TypeChecker_Env.postprocess);
             FStar_TypeChecker_Env.identifier_info =
               (uu___1048_4985.FStar_TypeChecker_Env.identifier_info);
             FStar_TypeChecker_Env.tc_hooks =
               (uu___1048_4985.FStar_TypeChecker_Env.tc_hooks);
             FStar_TypeChecker_Env.dsenv =
               (uu___1048_4985.FStar_TypeChecker_Env.dsenv);
             FStar_TypeChecker_Env.nbe =
               (uu___1048_4985.FStar_TypeChecker_Env.nbe);
             FStar_TypeChecker_Env.strict_args_tab =
               (uu___1048_4985.FStar_TypeChecker_Env.strict_args_tab);
             FStar_TypeChecker_Env.erasable_types_tab =
               (uu___1048_4985.FStar_TypeChecker_Env.erasable_types_tab);
             FStar_TypeChecker_Env.enable_defer_to_tac =
               (uu___1048_4985.FStar_TypeChecker_Env.enable_defer_to_tac)
           } in
         let uu____4989 = tc_modul env1 m b in
         match uu____4989 with
         | (m1, env2) ->
             ((let uu____5001 =
                 let uu____5002 =
                   FStar_Ident.string_of_lid m1.FStar_Syntax_Syntax.name in
                 FStar_Options.dump_module uu____5002 in
               if uu____5001
               then
              ...
              (let uu____5006 =
                 (let uu____5009 =
                    FStar_Ident.string_of_lid m1.FStar_Syntax_Syntax.name in
                  FStar_Options.dump_module uu____5009) &&
                   (let uu____5011 =
                      FStar_Ident.string_of_lid m1.FStar_Syntax_Syntax.name in
                    FStar_Options.debug_at_level uu____5011
                   ...
                   | FStar_Syntax_Syntax.Sig_let ((b1, lbs), ids) ->
                       ...
                       let update lb =
                         ...
                         | (univnames, e) ->
                             ...
                             {
                               FStar_Syntax_Syntax.lbname =
                                 (uu___1070_5051.FStar_Syntax_Syntax.lbname);
                               FStar_Syntax_Syntax.lbunivs =
                                 (uu___1070_5051.FStar_Syntax_Syntax.lbunivs);
                               FStar_Syntax_Syntax.lbtyp =
                                 (uu___1070_5051.FStar_Syntax_Syntax.lbtyp);
                               FStar_Syntax_Syntax.lbeff =
                                 (uu___1070_5051.FStar_Syntax_Syntax.lbeff);
                               FStar_Syntax_Syntax.lbdef = uu____5052;
                               FStar_Syntax_Syntax.lbattrs =
                                 (uu___1070_5051.FStar_Syntax_Syntax.lbattrs);
                               FStar_Syntax_Syntax.lbpos =
                                 (uu___1070_5051.FStar_Syntax_Syntax.lbpos)
                             } in
                       let uu___1072_5056 = se in
                       let uu____5057 =
                         let uu____5058 =
                           let uu____5065 =
                             ...
                             (b1, uu____5066) in
                           (uu____5065, ids) in
                         FStar_Syntax_Syntax.Sig_let uu____5058 in
                       {
                         FStar_Syntax_Syntax.sigel = uu____5057;
                         FStar_Syntax_Syntax.sigrng =
                           (uu___1072_5056.FStar_Syntax_Syntax.sigrng);
                         FStar_Syntax_Syntax.sigquals =
                           (uu___1072_5056.FStar_Syntax_Syntax.sigquals);
                         FStar_Syntax_Syntax.sigmeta =
                           (uu___1072_5056.FStar_Syntax_Syntax.sigmeta);
                         FStar_Syntax_Syntax.sigattrs =
                           (uu___1072_5056.FStar_Syntax_Syntax.sigattrs);
                         FStar_Syntax_Syntax.sigopts =
                           (uu___1072_5056.FStar_Syntax_Syntax.sigopts)
                       }
                   | uu____5073 -> se in
                 let normalized_module =
                   let uu___1076_5075 = m1 in
                   let uu____5076 =
                     FStar_List.map normalize_toplevel_lets
                       m1.FStar_Syntax_Syntax.declarations in
                   {
                     FStar_Syntax_Syntax.name =
                       (uu___1076_5075.FStar_Syntax_Syntax.name);
                     FStar_Syntax_Syntax.declarations = uu____5076;
                     FStar_Syntax_Syntax.is_interface =
                       (uu___1076_5075.FStar_Syntax_Syntax.is_interface)
                   } in
                 let uu____5077 =

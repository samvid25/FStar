...
let (load_interface_decls :
  ...
  fun env ->
    fun interface_file_name ->
      ...
      | FStar_Parser_ParseIt.Term uu____787 ->
          failwith
  ...
  fun mllibs ->
    ...
    then
      let ext =
        ...
        | uu____803 -> failwith "Unrecognized option" in
      match opt with
      ...
      | FStar_Pervasives_Native.Some (FStar_Options.Kremlin) ->
          ...
          (match programs with
           | (name, uu____822)::[] ->
               ...
               FStar_Util.save_value_to_file uu____823 bin
           | uu____824 ->
               let uu____827 = FStar_Options.prepend_output_dir "out.krml" in
               FStar_Util.save_value_to_file uu____827 bin)
      | uu____828 -> failwith "Unrecognized option"
    else ()
let (tc_one_file :
  uenv ->
    Prims.string FStar_Pervasives_Native.option ->
    ...
    fun pre_fn ->
      fun fn ->
        fun parsing_data ->
          ...
          (let maybe_restore_opts uu____878 =
             let uu____879 =
               let uu____880 = FStar_Options.interactive () in
               Prims.op_Negation uu____880 in
             if uu____879
             then
               let uu____881 = FStar_Options.restore_cmd_line_options true in
               FStar_All.pipe_right uu____881 (fun uu____882 -> ())
             else () in
           let post_smt_encoding uu____889 = FStar_SMTEncoding_Z3.refresh () in
           let maybe_extract_mldefs tcmod env1 =
             let uu____907 =
               (let uu____910 = FStar_Options.codegen () in
                uu____910 = FStar_Pervasives_Native.None) ||
                 (let uu____916 =
                    let uu____917 =
                      FStar_Ident.string_of_lid
                        tcmod.FStar_Syntax_Syntax.name in
                    FStar_Options.should_extract uu____917 in
                  Prims.op_Negation uu____916) in
             if uu____907
                 ...
                 (fun uu____930 ->
                    with_env env1
                      (fun env2 ->
                         ...
                         match uu____938 with | (uu____947, defs) -> defs)) in
           let maybe_extract_ml_iface tcmod env1 =
             let uu____968 =
               let uu____969 = FStar_Options.codegen () in
               uu____969 = FStar_Pervasives_Native.None in
             if uu____968
             then (env1, Prims.int_zero)
               ...
               FStar_Util.record_time
                 (fun uu____983 ->
                    ...
                    match uu____984 with | (env2, uu____996) -> env2) in
             ...
             | (fmod, env1) ->
                 let mii =
                   let uu____1027 =
                     ...
                     uu____1028.FStar_TypeChecker_Env.dsenv in
                   FStar_Syntax_DsEnv.inclusion_info uu____1027
                     fmod.FStar_Syntax_Syntax.name in
                 let check_mod uu____1042 =
                   let check env2 =
                          ...
                          (let uu____1085 =
                           ...
                           | (modul, env3) ->
                               (maybe_restore_opts ();
                                (let smt_decls =
                                   let uu____1114 =
                                     let uu____1115 = FStar_Options.lax () in
                                     Prims.op_Negation uu____1115 in
                                   if uu____1114
                                   then
                                     let smt_decls =
                   ...
                   let uu____1149 =
                     let uu____1164 =
                       let uu____1167 =
                         FStar_Ident.string_of_lid
                           fmod.FStar_Syntax_Syntax.name in
                       FStar_Pervasives_Native.Some uu____1167 in
                     FStar_Profiling.profile (fun uu____1183 -> check env1)
                       uu____1164 "FStar.Universal.tc_source_file" in
                   match uu____1149 with
                   | ((tcmod, smt_decls), env2) ->
                       let tc_time = Prims.int_zero in
                       let uu____1218 = maybe_extract_mldefs tcmod env2 in
                 ...
                 let uu____1256 =
                   (let uu____1259 =
                    ...
                    FStar_Options.should_verify uu____1259) &&
                     ((FStar_Options.record_hints ()) ||
                        (FStar_Options.use_hints ())) in
                 if uu____1256
                 then
                   let uu____1268 = FStar_Parser_ParseIt.find_file fn in
                   FStar_SMTEncoding_Solver.with_hints_db uu____1268
                     check_mod
                 else check_mod () in
           let uu____1278 =
             let uu____1279 = FStar_Options.cache_off () in
           ...
           then
             ...
             let r1 =
               ...
               if uu____1294 then FStar_Pervasives_Native.None else r in
             match r1 with
             | FStar_Pervasives_Native.None ->
                 ((let uu____1307 =
                     let uu____1308 = FStar_Parser_Dep.module_name_of_file fn in
                     FStar_Options.should_be_already_cached uu____1308 in
                   if uu____1307
                   then
                     let uu____1309 =
                       let uu____1314 =
                       ...
                       (FStar_Errors.Error_AlreadyCachedAssertionFailure,
                         uu____1314) in
                     FStar_Errors.raise_err uu____1309
                   else ());
                  (let uu____1317 =
                     (let uu____1320 = FStar_Options.codegen () in
                      FStar_Option.isSome uu____1320) &&
                   ...
                   then
                     let uu____1323 =
                       ...
                       (FStar_Errors.Error_AlreadyCachedAssertionFailure,
                         uu____1328) in
                     FStar_Errors.raise_err uu____1323
                   else ());
                  (let uu____1330 =
                     let uu____1339 = FStar_Options.should_check_file fn in
                     if uu____1339
                     then tc_source_file ()
                     else
                       FStar_Errors.with_ctx
                         (Prims.op_Hat "While checking dependency " fn)
                         (fun uu____1358 -> tc_source_file ()) in
                   match uu____1330 with
                   | (tc_result, mllib, env1) ->
                       ((let uu____1375 =
                           (let uu____1378 = FStar_Errors.get_err_count () in
                            uu____1378 = Prims.int_zero) &&
                             ((FStar_Options.lax ()) ||
                                (let uu____1380 =
                                   FStar_Ident.string_of_lid
                                     (tc_result.FStar_CheckedFiles.checked_module).FStar_Syntax_Syntax.name in
                                 FStar_Options.should_verify uu____1380)) in
                         if uu____1375
                         then
             ...
             | FStar_Pervasives_Native.Some tc_result ->
                 ...
                 ((let uu____1394 =
                     let uu____1395 =
                       FStar_Ident.string_of_lid
                         tcmod.FStar_Syntax_Syntax.name in
                     FStar_Options.dump_module uu____1395 in
                   if uu____1394
                   then
                     let uu____1396 =
                  ...
                  (let extend_tcenv tcmod1 tcenv =
                     ...
                     | (uu____1434, tcenv1) ->
                         ...
                         (maybe_restore_opts ();
                          (let uu____1439 =
                             let uu____1440 = FStar_Options.lax () in
                   ...
                   let mllib =
                     let uu____1459 =
                       ((let uu____1462 = FStar_Options.codegen () in
                         uu____1462 <> FStar_Pervasives_Native.None) &&
                          (let uu____1468 =
                             FStar_Ident.string_of_lid
                               tcmod.FStar_Syntax_Syntax.name in
                           FStar_Options.should_extract uu____1468))
                         &&
                         ((Prims.op_Negation
                             tcmod.FStar_Syntax_Syntax.is_interface)
                            ||
                            (let uu____1470 = FStar_Options.codegen () in
                             uu____1470 =
                               (FStar_Pervasives_Native.Some
                                  FStar_Options.Kremlin))) in
                     if uu____1459
                     then
                       let uu____1477 = maybe_extract_mldefs tcmod env1 in
                       match uu____1477 with
                       | (extracted_defs, _extraction_time) -> extracted_defs
                     else FStar_Pervasives_Native.None in
                   let uu____1493 = maybe_extract_ml_iface tcmod env1 in
                   match uu____1493 with
                   | (env2, _time) -> (tc_result, mllib, env2)))
           else
             (let uu____1511 = tc_source_file () in
    ...
    fun pre_fn ->
      fun fn ->
        fun parsing_data ->
          ...
          let uu____1570 = tc_one_file env1 pre_fn fn parsing_data in
          match uu____1570 with
          | (tc_result, uu____1584, env2) ->
              let uu____1590 = FStar_Extraction_ML_UEnv.tcenv_of_uenv env2 in
              (tc_result, uu____1590)
let (needs_interleaving : Prims.string -> Prims.string -> Prims.bool) =
  fun intf ->
    fun impl ->
      ...
      ((m1 = m2) &&
         (let uu____1604 = FStar_Util.get_file_extension intf in
          FStar_List.mem uu____1604 ["fsti"; "fsi"]))
        &&
        (let uu____1606 = FStar_Util.get_file_extension impl in
         FStar_List.mem uu____1606 ["fst"; "fs"])
                  ...
                  | (remaining1, nmod, mllib, env1) ->
                      ((let uu____1957 =
                        ...
                        then
                          ...
                          FStar_Profiling.report_and_clear uu____1959
                        else ());
       ...
       then
         (FStar_Util.print_endline "Auto-deps kicked in; here's some info.";
          ...
          (let uu____1994 =
             ...
             FStar_String.concat " " uu____1995 in
           FStar_Util.print1
             "Here's the list of modules we will verify: %s\n" uu____1994))
       else ());
      (let env =
         let uu____2004 = init_env dep_graph in
         FStar_Extraction_ML_UEnv.new_uenv uu____2004 in
       let uu____2005 = tc_fold_interleave dep_graph ([], [], env) filenames in
                   ...
                   (fun tcenv ->
                      (let uu____2058 =
                         (FStar_Options.interactive ()) &&
                           (let uu____2060 = FStar_Errors.get_err_count () in
                            uu____2060 = Prims.int_zero) in
                       if uu____2058
                       then
                         ...
                         (tcenv.FStar_TypeChecker_Env.solver).FStar_TypeChecker_Env.finish
                           ());
                      ((), tcenv)) in
               FStar_All.pipe_left FStar_Pervasives_Native.snd uu____2049 in

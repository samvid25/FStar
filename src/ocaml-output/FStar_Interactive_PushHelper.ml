      ...
      fun task ->
                 ...
                 (match uu____1232 with
                  | (env, finish_name_tracking) ->
                      ...
                      (match uu____1272 with
                       | (curmod, env1) ->
                           let st2 =
                             let uu___230_1286 = st1 in
                             {
                               FStar_Interactive_JsonHelper.repl_line =
                                 (uu___230_1286.FStar_Interactive_JsonHelper.repl_line);
                               FStar_Interactive_JsonHelper.repl_column =
                                 (uu___230_1286.FStar_Interactive_JsonHelper.repl_column);
                               FStar_Interactive_JsonHelper.repl_fname =
                                 (uu___230_1286.FStar_Interactive_JsonHelper.repl_fname);
                               FStar_Interactive_JsonHelper.repl_deps_stack =
                                 (uu___230_1286.FStar_Interactive_JsonHelper.repl_deps_stack);
                               FStar_Interactive_JsonHelper.repl_curmod =
                                 curmod;
                               FStar_Interactive_JsonHelper.repl_env = env1;
                               FStar_Interactive_JsonHelper.repl_stdin =
                                 (uu___230_1286.FStar_Interactive_JsonHelper.repl_stdin);
                               FStar_Interactive_JsonHelper.repl_names =
                                 (uu___230_1286.FStar_Interactive_JsonHelper.repl_names)
                             } in
        ...
        | FStar_Errors.Error (e, msg, r, _ctx) ->
            let uu____1337 =
              ...
              FStar_Pervasives_Native.Some uu____1340 in
            (uu____1337, st)
            ...
            let uu____1350 =
              let uu____1353 =
                FStar_Interactive_JsonHelper.js_diag
                  st.FStar_Interactive_JsonHelper.repl_fname msg
                  FStar_Pervasives_Native.None in
              FStar_Pervasives_Native.Some uu____1353 in
            (uu____1350, st)
        | FStar_Errors.Stop ->
...
let (tf_of_fname : Prims.string -> FStar_Interactive_JsonHelper.timed_fname)
  ...
  fun fname ->
    ...
    {
      FStar_Interactive_JsonHelper.tf_fname = fname;
      FStar_Interactive_JsonHelper.tf_modtime = uu____1364
    }
let (update_task_timestamps :
  ...
  fun uu___0_1369 ->
    ...
    | FStar_Interactive_JsonHelper.LDInterleaved (intf, impl) ->
        ...
        FStar_Interactive_JsonHelper.LDInterleaved uu____1372
    | FStar_Interactive_JsonHelper.LDSingle intf_or_impl ->
        let uu____1380 =
          tf_of_fname intf_or_impl.FStar_Interactive_JsonHelper.tf_fname in
        FStar_Interactive_JsonHelper.LDSingle uu____1380
    | FStar_Interactive_JsonHelper.LDInterfaceOfCurrentFile intf ->
        let uu____1382 =
          tf_of_fname intf.FStar_Interactive_JsonHelper.tf_fname in
        FStar_Interactive_JsonHelper.LDInterfaceOfCurrentFile uu____1382
    | other -> other
let (repl_ldtx :
  FStar_Interactive_JsonHelper.repl_state ->
  ...
  fun st ->
    fun tasks ->
      let rec revert_many st1 uu___1_1418 =
        match uu___1_1418 with
        | [] -> st1
        | (_id, (task, _st'))::entries ->
            ...
            let dep_graph =
              FStar_TypeChecker_Env.dep_graph
                st1.FStar_Interactive_JsonHelper.repl_env in
            let st'1 =
              let uu___262_1466 = st' in
              let uu____1467 =
                FStar_TypeChecker_Env.set_dep_graph
                  st'.FStar_Interactive_JsonHelper.repl_env dep_graph in
              {
                FStar_Interactive_JsonHelper.repl_line =
                  (uu___262_1466.FStar_Interactive_JsonHelper.repl_line);
                FStar_Interactive_JsonHelper.repl_column =
                  (uu___262_1466.FStar_Interactive_JsonHelper.repl_column);
                FStar_Interactive_JsonHelper.repl_fname =
                  (uu___262_1466.FStar_Interactive_JsonHelper.repl_fname);
                FStar_Interactive_JsonHelper.repl_deps_stack =
                  (uu___262_1466.FStar_Interactive_JsonHelper.repl_deps_stack);
                FStar_Interactive_JsonHelper.repl_curmod =
                  (uu___262_1466.FStar_Interactive_JsonHelper.repl_curmod);
                FStar_Interactive_JsonHelper.repl_env = uu____1467;
                FStar_Interactive_JsonHelper.repl_stdin =
                  (uu___262_1466.FStar_Interactive_JsonHelper.repl_stdin);
                FStar_Interactive_JsonHelper.repl_names =
                  (uu___262_1466.FStar_Interactive_JsonHelper.repl_names)
              } in
      ...
      let rec aux st1 tasks1 previous =
        ...
        | (task::tasks2, []) ->
            ...
            let uu____1517 = repl_tx st1 LaxCheck timestamped_task in
            (match uu____1517 with
             | (diag, st2) ->
                 if Prims.op_Negation (FStar_Util.is_some diag)
                 then
                   let uu____1538 =
                     let uu___282_1539 = st2 in
                     let uu____1540 = FStar_ST.op_Bang repl_stack in
                     {
                       FStar_Interactive_JsonHelper.repl_line =
                         (uu___282_1539.FStar_Interactive_JsonHelper.repl_line);
                       FStar_Interactive_JsonHelper.repl_column =
                         (uu___282_1539.FStar_Interactive_JsonHelper.repl_column);
                       FStar_Interactive_JsonHelper.repl_fname =
                         (uu___282_1539.FStar_Interactive_JsonHelper.repl_fname);
                       FStar_Interactive_JsonHelper.repl_deps_stack =
                         uu____1540;
                       FStar_Interactive_JsonHelper.repl_curmod =
                         (uu___282_1539.FStar_Interactive_JsonHelper.repl_curmod);
                       FStar_Interactive_JsonHelper.repl_env =
                         (uu___282_1539.FStar_Interactive_JsonHelper.repl_env);
                       FStar_Interactive_JsonHelper.repl_stdin =
                         (uu___282_1539.FStar_Interactive_JsonHelper.repl_stdin);
                       FStar_Interactive_JsonHelper.repl_names =
                         (uu___282_1539.FStar_Interactive_JsonHelper.repl_names)
                     } in
                   aux uu____1538 tasks2 []
                 else FStar_Util.Inr st2)
        | (task::tasks2, prev::previous1) when
            let uu____1570 = update_task_timestamps task in
            (FStar_Pervasives_Native.fst (FStar_Pervasives_Native.snd prev))
              = uu____1570
            -> aux st1 tasks2 previous1
        | (tasks2, previous1) ->
            let uu____1585 = revert_many st1 previous1 in
            aux uu____1585 tasks2 [] in
      aux st tasks
         ...
         | () ->
             ...
             (match uu____1638 with
              | (deps, tasks, dep_graph) ->
                  let st1 =
                    let uu___306_1671 = st in
                    let uu____1672 =
                      FStar_TypeChecker_Env.set_dep_graph
                        st.FStar_Interactive_JsonHelper.repl_env dep_graph in
                    {
                      FStar_Interactive_JsonHelper.repl_line =
                        (uu___306_1671.FStar_Interactive_JsonHelper.repl_line);
                      FStar_Interactive_JsonHelper.repl_column =
                        (uu___306_1671.FStar_Interactive_JsonHelper.repl_column);
                      FStar_Interactive_JsonHelper.repl_fname =
                        (uu___306_1671.FStar_Interactive_JsonHelper.repl_fname);
                      FStar_Interactive_JsonHelper.repl_deps_stack =
                        (uu___306_1671.FStar_Interactive_JsonHelper.repl_deps_stack);
                      FStar_Interactive_JsonHelper.repl_curmod =
                        (uu___306_1671.FStar_Interactive_JsonHelper.repl_curmod);
                      FStar_Interactive_JsonHelper.repl_env = uu____1672;
                      FStar_Interactive_JsonHelper.repl_stdin =
                        (uu___306_1671.FStar_Interactive_JsonHelper.repl_stdin);
                      FStar_Interactive_JsonHelper.repl_names =
                        (uu___306_1671.FStar_Interactive_JsonHelper.repl_names)
                    } in
                  let uu____1673 = repl_ldtx st1 tasks in
        ...
        let capitalize str =
          ...
          then str
            ...
            (let first =
             ...
             Prims.op_Hat (FStar_String.uppercase first) uu____1747) in
        let mods = FStar_Parser_Dep.build_inclusion_candidates_list () in
        let loaded_mods_set =
          let uu____1758 = FStar_Util.psmap_empty () in
          let uu____1761 =
            let uu____1764 = FStar_Options.prims () in uu____1764 :: deps in
          FStar_List.fold_left
            (fun acc ->
               fun dep ->
                 let uu____1774 = FStar_Parser_Dep.lowercase_module_name dep in
                 FStar_Util.psmap_add acc uu____1774 true) uu____1758
            uu____1761 in
        let loaded modname =
             ...
             fun uu____1792 ->
               ...
               | (modname, mod_path) ->
                   ...
                   then table1
                     ...
                     (let ns_query =
                        let uu____1804 = capitalize modname in
                        FStar_Util.split uu____1804 "." in
                      let uu____1805 = loaded mod_key in
                      FStar_Interactive_CompletionTable.register_module_path
                        table1 uu____1805 mod_path ns_query)) table
          (FStar_List.rev mods)
let (full_lax :
  Prims.string ->
    FStar_Interactive_JsonHelper.repl_state ->
    ...
    fun st ->
      ...
      (let frag =
       ...
       | FStar_Util.Inl (st1, deps) ->
           ...
           repl_tx
             (let uu___343_1860 = st1 in
              {
                FStar_Interactive_JsonHelper.repl_line =
                  (uu___343_1860.FStar_Interactive_JsonHelper.repl_line);
                FStar_Interactive_JsonHelper.repl_column =
                  (uu___343_1860.FStar_Interactive_JsonHelper.repl_column);
                FStar_Interactive_JsonHelper.repl_fname =
                  (uu___343_1860.FStar_Interactive_JsonHelper.repl_fname);
                FStar_Interactive_JsonHelper.repl_deps_stack =
                  (uu___343_1860.FStar_Interactive_JsonHelper.repl_deps_stack);
                FStar_Interactive_JsonHelper.repl_curmod =
                  (uu___343_1860.FStar_Interactive_JsonHelper.repl_curmod);
                FStar_Interactive_JsonHelper.repl_env =
                  (uu___343_1860.FStar_Interactive_JsonHelper.repl_env);
                FStar_Interactive_JsonHelper.repl_stdin =
                  (uu___343_1860.FStar_Interactive_JsonHelper.repl_stdin);
                FStar_Interactive_JsonHelper.repl_names = names
